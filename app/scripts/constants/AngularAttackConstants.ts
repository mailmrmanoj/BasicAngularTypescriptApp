...
module AngularAttack {
    export class AngularAttackConstants {
        ...
        public static SERVICES = "angular.attack.services";
        public static FACTORIES = "angular.attack.factories";
        public static INTERCEPTORS = "angular.attack.interceptors";
        public static FILTERS = "angular.attack.filters";
